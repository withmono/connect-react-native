...
import { MonoConnectProps, MonoEventData, WebviewMessage } from './types';
...
const MonoConnect: React.FC<MonoConnectProps> = (props) => {
  ...
  const connect_url = React.useMemo(() => {
    const qs: any = {
      ...
      check_account_match: otherConfig?.checkAccountMatch,
      version: '2023-12-14',
      ...otherConfig,
    };
    return createUrl(qs);
      ...
      <SafeAreaView style={[{ flex: 1, backgroundColor: 'rgba(0,0,0, 0.6)' }]}>
        <WebView
          ...
          renderLoading={() => <View style={{
            ...
            height: '100%',
          }}><ActivityIndicator size="small" color="#182CD1" /></View>}
